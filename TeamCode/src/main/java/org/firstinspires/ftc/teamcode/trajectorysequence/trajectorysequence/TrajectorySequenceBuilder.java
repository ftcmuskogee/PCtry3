package org.firstinspires.ftc.teamcode.trajectorysequence.trajectorysequence;
...
import org.firstinspires.ftc.teamcode.trajectorysequence.trajectorysequence.sequencesegment.SequenceSegment;
import org.firstinspires.ftc.teamcode.trajectorysequence.trajectorysequence.sequencesegment.TrajectorySegment;
import org.firstinspires.ftc.teamcode.trajectorysequence.trajectorysequence.sequencesegment.TurnSegment;
import org.firstinspires.ftc.teamcode.trajectorysequence.trajectorysequence.sequencesegment.WaitSegment;
...
public class TrajectorySequenceBuilder {
    ...
    private final List<org.firstinspires.ftc.teamcode.trajectorysequence.trajectorysequence.sequencesegment.SequenceSegment> sequenceSegments;
    ...
    public TrajectorySequenceBuilder turn(double angle, double maxAngVel, double maxAngAccel) {
        ...
        sequenceSegments.add(new org.firstinspires.ftc.teamcode.trajectorysequence.trajectorysequence.sequencesegment.TurnSegment(lastPose, angle, turnProfile, Collections.emptyList()));
    ...
    private List<TrajectoryMarker> convertMarkersToGlobal(
            List<org.firstinspires.ftc.teamcode.trajectorysequence.trajectorysequence.sequencesegment.SequenceSegment> sequenceSegments,
    ...
    private List<org.firstinspires.ftc.teamcode.trajectorysequence.trajectorysequence.sequencesegment.SequenceSegment> projectGlobalMarkersToLocalSegments(List<TrajectoryMarker> markers, List<org.firstinspires.ftc.teamcode.trajectorysequence.trajectorysequence.sequencesegment.SequenceSegment> sequenceSegments) {
        ...
        for (TrajectoryMarker marker : markers) {
            org.firstinspires.ftc.teamcode.trajectorysequence.trajectorysequence.sequencesegment.SequenceSegment segment = null;

            double markerTime = marker.getTime();
            double segmentOffsetTime = 0;

            while (segmentIndex < sequenceSegments.size()) {
                org.firstinspires.ftc.teamcode.trajectorysequence.trajectorysequence.sequencesegment.SequenceSegment seg = sequenceSegments.get(segmentIndex);
            ...
            org.firstinspires.ftc.teamcode.trajectorysequence.trajectorysequence.sequencesegment.SequenceSegment newSegment = null;
            ...
            } else if (segment instanceof org.firstinspires.ftc.teamcode.trajectorysequence.trajectorysequence.sequencesegment.TurnSegment) {
                org.firstinspires.ftc.teamcode.trajectorysequence.trajectorysequence.sequencesegment.TurnSegment thisSegment = (org.firstinspires.ftc.teamcode.trajectorysequence.trajectorysequence.sequencesegment.TurnSegment) segment;
                
                List<TrajectoryMarker> newMarkers = new ArrayList<>(thisSegment.getMarkers());
                newMarkers.add(new TrajectoryMarker(segmentOffsetTime, marker.getCallback()));

                newSegment = new TurnSegment(thisSegment.getStartPose(), thisSegment.getTotalRotation(), thisSegment.getMotionProfile(), newMarkers);
            } else if (segment instanceof org.firstinspires.ftc.teamcode.trajectorysequence.trajectorysequence.sequencesegment.TrajectorySegment) {
    ...
    private Double displacementToTime(List<SequenceSegment> sequenceSegments, double s) {
        ...
        for (org.firstinspires.ftc.teamcode.trajectorysequence.trajectorysequence.sequencesegment.SequenceSegment segment : sequenceSegments) {
            if (segment instanceof org.firstinspires.ftc.teamcode.trajectorysequence.trajectorysequence.sequencesegment.TrajectorySegment) {
                org.firstinspires.ftc.teamcode.trajectorysequence.trajectorysequence.sequencesegment.TrajectorySegment thisSegment = (org.firstinspires.ftc.teamcode.trajectorysequence.trajectorysequence.sequencesegment.TrajectorySegment) segment;
    ...
    private Double pointToTime(List<org.firstinspires.ftc.teamcode.trajectorysequence.trajectorysequence.sequencesegment.SequenceSegment> sequenceSegments, Vector2d point) {
